...
<html>
	...
	<body background="images/backgroundteste.png">
		...
		<div class = "rooms">
			...
			<div class = "cont">
				<h2>Quartos arrumados, com bebidas, e nunca houve mortes aqui</h2>
				<img src="images/room1.jpg" style="margin-left: 10px;width:50%;">
			</div>
			<div class = "cont">
				<h2>Manutenções frequentes, apenas necessitando chamar o gerente Norman</h2>
				<img src="images/room2.jpg" style="margin-left: 10px;">
			</div>
		</div>
	</body>
</html>