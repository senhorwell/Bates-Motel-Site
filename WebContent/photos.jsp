...
<html>
	...
	<body background="images/backgroundteste.png">
		...
		<div class = "photo">
			...
			<div class = "cont">
				<img src="images/photo1.png" style="margin-left: 10px;width:50%;">
			</div>
			<div class = "cont">
				<img src="images/photo2.jpg" style="margin-left: 10px;width:50%;">
			</div>
			<div class = "cont">
				<img src="images/photo4.jpg" style="margin-left: 10px;width:50%;">
			</div>
			<div class = "cont">
				<img src="images/photo5.jpg" style="margin-left: 10px;width:50%;">
			</div>
			<div class = "cont">
				<img src="images/photo3.jpg" style="margin-left: 10px;">
			</div>
		</div>
	</body>
</html>